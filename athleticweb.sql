...
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	(NULL, 'athleticweb', 'atleta', 'IDAtleta', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'atleta', 'NomAtleta', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'atleta', 'EdadAtleta', 3, NULL, 'NO', 'char', 2, 6, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'atleta', 'OrgAtleta', 4, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'atleta', 'DiscAtleta', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'disciplina', 'DiscipID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'athleticweb', 'disciplina', 'DiscipNom', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
...
INSERT INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	(NULL, 'athleticweb', 'PRIMARY', NULL, 'athleticweb', 'atleta', 'IDAtleta', 1, NULL, NULL, NULL, NULL),
	(NULL, 'athleticweb', 'FK_atleta_disciplina', NULL, 'athleticweb', 'atleta', 'DiscAtleta', 1, 1, 'athleticweb', 'disciplina', 'DiscipID'),
	(NULL, 'athleticweb', 'PRIMARY', NULL, 'athleticweb', 'disciplina', 'DiscipID', 1, NULL, NULL, NULL, NULL),
...
INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	(NULL, 'athleticweb', 'utf8', 'utf8_spanish_ci', NULL),
...
INSERT INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`) VALUES
	(NULL, 'athleticweb', 'atleta', 0, 'athleticweb', 'PRIMARY', 1, 'IDAtleta', 'A', 7, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'athleticweb', 'atleta', 1, 'athleticweb', 'FK_atleta_disciplina', 1, 'DiscAtleta', 'A', 7, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'athleticweb', 'disciplina', 0, 'athleticweb', 'PRIMARY', 1, 'DiscipID', 'A', 9, NULL, NULL, '', 'BTREE', ''),
	...
	(NULL, 'mysql', 'user', 0, 'mysql', 'PRIMARY', 1, 'Host', 'A', 2, NULL, NULL, '', 'BTREE', ''),
...
INSERT INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	...
	(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-28 20:51:21', '2016-09-28 20:51:21', NULL, 'utf8_general_ci', NULL, 'max_rows=3540', ''),
	...
	(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-28 20:51:21', '2016-09-28 20:51:21', NULL, 'utf8_general_ci', NULL, 'max_rows=3726', ''),
	...
	(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-28 20:51:21', '2016-09-28 20:51:21', NULL, 'utf8_general_ci', NULL, 'max_rows=3108', ''),
	...
	(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-28 20:51:21', '2016-09-28 20:51:21', NULL, 'utf8_general_ci', NULL, 'max_rows=6123', ''),
	(NULL, 'athleticweb', 'atleta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 0, 11, '2016-08-21 13:28:18', NULL, NULL, 'utf8_spanish_ci', NULL, '', 'InnoDB free: 4096 kB; (`DiscAtleta`) REFER `athleticweb/disciplina`(`DiscipID`)'),
	(NULL, 'athleticweb', 'disciplina', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 0, 0, 10, '2016-08-21 13:35:40', NULL, NULL, 'utf8_spanish_ci', NULL, '', 'InnoDB free: 4096 kB'),
	(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 1024, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Column privileges'),
	(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 438, 876, 123286039799267327, 4096, 0, NULL, '2008-01-11 12:23:56', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Database privileges'),
	(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'User defined functions'),
	(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'help categories'),
	(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 401, 197, 78997, 55450570411999231, 14336, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'help keywords'),
	(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 825, 9, 7425, 2533274790395903, 16384, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:24:00', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 475, 730, 347064, 281474976710655, 17408, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'help topics'),
	(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 109775240917155839, 1024, 0, NULL, '2008-01-11 12:23:56', '2008-01-11 17:23:56', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-01-11 12:23:58', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 1024, 0, NULL, '2008-01-11 12:23:58', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Procedure privileges'),
	(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 1024, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Table privileges'),
	(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Time zones'),
	(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-01-11 12:23:58', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Time zone names'),
	(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-01-11 12:23:57', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-01-11 12:23:58', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 51, 256, 281474976710655, 2048, 0, NULL, '2008-01-11 12:23:56', '2008-01-11 17:23:58', '2016-08-22 21:23:28', 'utf8_bin', NULL, '', 'Users and global privileges');
...
INSERT INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	(NULL, 'athleticweb', 'PRIMARY', 'athleticweb', 'atleta', 'PRIMARY KEY'),
	(NULL, 'athleticweb', 'FK_atleta_disciplina', 'athleticweb', 'atleta', 'FOREIGN KEY'),
	(NULL, 'athleticweb', 'PRIMARY', 'athleticweb', 'disciplina', 'PRIMARY KEY'),
...
-- Volcando estructura de base de datos para athleticweb
CREATE DATABASE IF NOT EXISTS `athleticweb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `athleticweb`;


-- Volcando estructura para tabla athleticweb.atleta
CREATE TABLE IF NOT EXISTS `atleta` (
  `IDAtleta` int(11) NOT NULL auto_increment,
  `NomAtleta` varchar(50) collate utf8_spanish_ci NOT NULL,
  `EdadAtleta` char(2) collate utf8_spanish_ci NOT NULL,
  `OrgAtleta` varchar(20) collate utf8_spanish_ci NOT NULL,
  `DiscAtleta` int(11) NOT NULL,
  PRIMARY KEY  (`IDAtleta`),
  KEY `FK_atleta_disciplina` (`DiscAtleta`),
  CONSTRAINT `FK_atleta_disciplina` FOREIGN KEY (`DiscAtleta`) REFERENCES `disciplina` (`DiscipID`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla athleticweb.atleta: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `atleta` DISABLE KEYS */;
INSERT INTO `atleta` (`IDAtleta`, `NomAtleta`, `EdadAtleta`, `OrgAtleta`, `DiscAtleta`) VALUES
	(1, 'Björg Rasmüssen', '23', '3', 3),
	(2, 'Jean-François Gillet', '36', '1', 2),
	(3, 'Zlatan Ibrahimovic', '34', '3', 2),
	(4, 'Martin Roßmann', '27', '2', 4),
	(8, 'Jürgen Van Baden', '28', '1', 4),
	(9, 'Jenna Rosenberg', '22', '3', 5),
	(10, 'Johann Van Beckett', '25', '2', 8);
/*!40000 ALTER TABLE `atleta` ENABLE KEYS */;


-- Volcando estructura para tabla athleticweb.disciplina
CREATE TABLE IF NOT EXISTS `disciplina` (
  `DiscipID` int(10) NOT NULL auto_increment,
  `DiscipNom` varchar(50) collate utf8_spanish_ci NOT NULL,
  PRIMARY KEY  (`DiscipID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla athleticweb.disciplina: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `disciplina` DISABLE KEYS */;
INSERT INTO `disciplina` (`DiscipID`, `DiscipNom`) VALUES
	(1, 'Baloncesto'),
	(2, 'Fútbol'),
	(3, '100 m libres'),
	(4, 'Maratón'),
...
-- Volcando datos para la tabla mysql.columns_priv: 0 rows
...
-- Volcando datos para la tabla mysql.db: 2 rows
...
-- Volcando datos para la tabla mysql.func: 0 rows
...
-- Volcando datos para la tabla mysql.help_category: 36 rows
...
-- Volcando datos para la tabla mysql.help_keyword: 401 rows
...
-- Volcando datos para la tabla mysql.help_relation: 825 rows
...
-- Volcando datos para la tabla mysql.help_topic: 475 rows
...
-- Volcando estructura para tabla mysql.host
...
-- Volcando datos para la tabla mysql.host: 0 rows
...
-- Volcando datos para la tabla mysql.proc: 0 rows
...
-- Volcando datos para la tabla mysql.procs_priv: 0 rows
...
-- Volcando datos para la tabla mysql.tables_priv: 0 rows
...
-- Volcando datos para la tabla mysql.time_zone: 0 rows
...
-- Volcando datos para la tabla mysql.time_zone_leap_second: 0 rows
...
-- Volcando datos para la tabla mysql.time_zone_name: 0 rows
...
-- Volcando datos para la tabla mysql.time_zone_transition: 0 rows
...
-- Volcando datos para la tabla mysql.time_zone_transition_type: 0 rows
...
-- Volcando datos para la tabla mysql.user: 5 rows
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`) VALUES
	('localhost', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0),
	('production.mysql.com', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0),
	('127.0.0.1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0),
	('localhost', '', '', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', _binary '', _binary '', _binary '', 0, 0, 0, 0),
	('production.mysql.com', '', '', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', _binary '', _binary '', _binary '', 0, 0, 0, 0);
