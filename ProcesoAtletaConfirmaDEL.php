<?php
    ...
    // cerrar conexión
    mysql_close($conex);            
    // generar formulario con datos para eliminar
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="contenido">
 <fieldset id="frm">
  <legend>Eliminar registro</legend>
   <form id="dataFRM" action="ProcesoAtletaDEL.php" method="POST">
    <table id="tblFRM">
     <tr>
      <td><b>ID:</b></td>
      <td>
     ...
     <tr>
      <td colspan="2">
       <input type="button" value="Eliminar" onclick="ConfirmDEL();" class="button"/>       
       <input type="button" value="Cancelar" onclick="SetPage('FormAtletaMod.php');" class="button"/>
      </td>
     </tr>                    
    </table>
   </form>
